...
operation::query-events[snippets='response-body,request-body,curl-request,http-response,links']
...
operation::createEvent[snippets='request-fields,curl-request,http-request,request-headers,http-response,response-headers,response-fields,links']
...
operation::get-an-event[snippets='curl-request,http-request,http-response,httpie-request,request-body,response-body']
